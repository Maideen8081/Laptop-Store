...
def _cart_id(request):#This function is used to get the card_id and it is private function
...
# increment tne item in add cart  
...
#remove button to remove the add cart
